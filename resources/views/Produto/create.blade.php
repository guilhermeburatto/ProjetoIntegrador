    ...
    <div class="container">
        <form method="post" action={{route('produto.store')}}>
            ...
            <div class="form-group">
              ...
              <small id="ID-help" class="form-text text-muted">Não é necessário informar um ID para cadastrar um novo dado.</small>
            </div>
            <div class="form-group">
              <label for="input-nome">Nome</label>
              <input name="nome" type="text" class="form-control" id="input-nome" placeholder="Informe o nome do produto">
            </div>
            <div class="form-group">
                <label for="input-preco">Preço</label>
                <input name="preco" type="text" class="form-control" id="input-preco" placeholder="Informe o preço do produto">
            </div>
            <div class="form-group">
